...
const check_data_API = async() => {
    ...
    const response = await fetch("https://farcryserver.herokuapp.com/farcryAPI/v1/players/check_availability/?player_email=" +
...
const submit_register_form_API = async() => {
    ...
    // Call register api
    const response = await fetch("https://farcryserver.herokuapp.com/farcryAPI/v1/players/register/", {
        method: "POST",
