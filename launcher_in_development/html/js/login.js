...
const checkUsernameAndPassword = async function () {
    ...
    if (player_name != "" && player_password != "") {
        ...
        const response1 = await fetch("http://127.0.0.1:8000/farcryAPI/v1/players/check_email/?player_email=" + player_name, {
            method: 'GET',
            headers: {
        ...
        const response2 = await fetch("http://127.0.0.1:8000/farcryAPI/v1/players/check_player_name/?player_name=" + player_name, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
